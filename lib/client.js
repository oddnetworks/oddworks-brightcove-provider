...
class Client {
	...
	// args.clientSecret *optional - Defaults to this.clientSecret. Requires
	//															 client credentials with permissions for
	//															 `video-cloud/player/all` operations
	// args.accountId *optional - Defaults to this.accountId
	// args.accessToken *optional - Overrides a generated accessToken via clientId/clientSecret
